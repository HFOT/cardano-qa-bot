export default {
  nodes: {
    ...
    "wallet-exchange-withdraw": {
      ...
      text: "取引所の出金画面に、あなたの個人ウォレットの「受け取る」画面で表示されたアドレスを正確にコピー&ペーストしてください。1文字でも間違えると資産が失われる可能性があります。ペースト後は、アドレスの最初と最後の数文字がウォレットの表示と一致しているか必ず目で確認しましょう(コピーしたアドレスをすり替えるウイルスへの対策です)。初めての送金では、まず少額だけ送って着金を確認してから、残りをまとめて送るのが安全です。",
      keywords: ["取引所出金"],
    },

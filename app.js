...
import walletContent from "./content/wallet.js?v=12";
import spoContent from "./content/spo.js?v=12";
import drepContent from "./content/drep.js?v=12";
import scamContent from "./content/scam.js?v=12";
